...
<body>
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <!-- Spinner End -->
        {{-- {{ dd($agent->agentProfile) }} --}}

        <!-- Sidebar Start -->
        <div style="height:100vh;" class="sidebar bg-light pe-4 pb-3">
            <nav class="navbar  navbar-light">
                <a href="/agent/dashboard" class="navbar-brand mx-4 mb-3">
                    
                    {{-- estado logo  --}}
                    <img class="mx-5" src={{ asset('assets/front/logo-primary.png') }} style="width: 70px !important; height: 70px !important; object-fit:cover; " alt="">
        ...
        @if ($agent)
        <img class="rounded-circle" src="{{ asset('storage/uploads/agent_profile/' . $agent->agentProfile) }}" alt="" style="width: 40px; height: 40px;">
        <div class="bg-success rounded-circle border border-white position-absolute end-0 bottom-0 p-1"></div>
    @else
        <img class="rounded-circle" src="{{ asset('assets/front/provider-user-2') }}" alt="Default avatar" style="width: 40px; height: 40px;">
    @endif
                    ...
                    <div class="ms-3">
                        ...
                        <span>@lang('back.agent')</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href="{{ route('admin.dashboard.agentHome') }}" class="nav-item nav-link"><i
                            class="fa fa-tachometer-alt me-2"></i>@lang('back.dashboard')</a>
                    ...
                    <a href="{{route('admin.dashboard.agentList')}}" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Agents</a> --}}
        ...
        <div class="content">
            ...
            <nav class=" navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link " data-bs-toggle="dropdown">
                            <img class="rounded-circle" src="{{ asset('storage/uploads/agent_profile/' . $agent->agentProfile) }}" alt="" style="width: 40px; height: 40px; object-fit:cover;">
                            <span class="d-none d-lg-inline-flex">{{ $agent->agentName }} </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="/agent/profile" class="dropdown-item">@lang('back.my_profile')</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row p-4 vh-100 bg-white rounded  justify-content-center mx-0">
                    <div class="col-md-12 text-center">
                        <div class="text-dark">
                         
                        {{-- <p class="text-center d-flex justify-content-center">@lang('back.welcome_agent') {{ $agent->agentName }}</p> --}}
                            {{-- @if (Auth::guard('agent')->check())
                                <p>Welcome, agentss!</p>
