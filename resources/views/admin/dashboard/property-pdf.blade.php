...
#customers tr:hover {background-color: #473333;}
...
<div class="col-md-12">   
    <div class="row">
        ...
        <div class="row">
            <img src="{{ $image }}" class="property-image" alt="Property Image" style="width:100%; height:500px; background-size:cover;" alt="">
        </div>
            ...
            <div class="row">
                <div class="table">
                    <table id="customers">
                        ...
                        <tr>
                            <td><h3><b>Floor Number</b></h3></td>
                            <td><h3><b>{{ $floor->floorNo }}</b></h3></td>
                          </tr>
