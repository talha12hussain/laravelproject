...
@section('content')
    ...
    <h1 class="text" style="margin-left: 0px !important; font-family: sans-serif"><b>@lang('back.edit_property')</b></h1>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-12 col-lg-12 col-md-12 col-11 text-center">
                <div class="card">
                    ...
                    @endif
                    <form class="form-card" method="POST" action="{{ route('admin.dashboard.updateProperty', $property->id) }}"
                        ...
                        <div class="row justify-content-between mt-3 text-left">
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label class="form-control-label px-3"><b>@lang('back.dimension_front')</b><span
                                        class="text-danger">*</span></label>
                                <input type="number" id="dimFront" name="dimFront" value={{ $property->dimFront }}
                                    >
                                @error('dimFront')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label class="form-control-label px-3"><b>@lang('back.dimension_width')</b><span
                                        class="text-danger">*</span></label>
                                <input type="number" id="dimWidth" value={{ $property->dimWidth }} name="dimWidth"
                                    >
                                @error('dimWidth')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label class="form-control-label px-3"><b>@lang('back.total_size')</b><span
                                        class="text-danger">*</span></label>
                                <input type="text" id="totalSize" value={{ $property->totalSize }} name="totalSize"
                                    >
                                @error('totalSize')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row justify-content-left mt-3 text-left">
                            <div class="form-group col-sm-4 flex-column d-flex">
                                ...
                                <input type="number" id="leasedArea" value={{ $property->leasedArea }} name="leasedArea"
                                    >
                                @error('leasedArea')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group col-sm-8 flex-column d-flex">
                                <label class="form-control-label px-3"><b>@lang('back.nearest_landmark')</b><span
                                        class="text-danger">*</span></label>
                                <input type="text" id="nearestLand" name="nearestLand"
                                    value={{ $property->nearestLand }} >
                                @error('nearestLand')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row justify-content-between mt-3 text-left">
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label class="form-control-label px-3"><b>@lang('back.plot_size')</b><span
                                        class="text-danger">*</span></label>
                                <input type="number" id="plotSize" name="plotSize" value={{ $property->plotSize }}
                                    >
                                @error('plotSize')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label class="form-control-label mb-2 px-3"><b>Plot Type</b> <span class="text-danger">*</span></label>
                                <select class="p-2 border rounded-3" id="plotType"  name="plot_type">
                                    <option {{$property->plot_type == "commercial" ? "selected" : ""}} value="commercial">Commercial</option>
                                    <option {{$property->plot_type == "warehouse" ? "selected" : ""}} value="warehouse">Warehouse</option>
                                    <option {{$property->plot_type == "shop" ? "selected" : ""}} value="shop">Shop</option>
                                    <option {{$property->plot_type == "showroom" ? "selected" : ""}} value="showroom">Showroom</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label for="size_type" class="form-control-label mb-2 px-3"><b>Size Type</b> <span class="text-danger">*</span></label>
                                <select class="p-2 border rounded-3"  id="sizeType" name="size_type">
                                    <option  {{$property->size_type == "sq_yard" ? "selected" : ""}} value="sq_yard">Sq. Yard</option>
                                    <option {{$property->size_type == "acre" ? "selected" : ""}}  value="acre">Acre</option>
                                    <option {{$property->size_type == "sq_fit" ? "selected" : ""}}  value="acre">Sq. Fit</option>
                                </select>
                            </div>
                            ...
                            <div class="d-flex jutify-content-left my-4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input border align-items-center  rounded-circle"
                                        ...
                                        value="Yes" {{ $property->corner === 'Yes' ? 'checked' : '' }}>
                                    <label class="form-check-label mx-1" for="inlineRadio1"><b>@lang('back.yes')</b></label>
                                </div>
                                <div class="form-check form-check-inline mx-2">
                                    <input class="form-check-input border align-items-center  rounded-circle" type="radio"
                                        name="corner" style="padding: 10px !important;" id="inlineRadio2" value="No"
                                        {{ $property->corner === 'No' ? 'checked' : '' }}>
                                    <label class="form-check-label mx-1" for="inlineRadio2"><b>@lang('back.no')</b></label>
                                </div>
                                @error('corner')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="my-2">
                            <h2 class="d-flex justify-start px-2 my-5" style="border-left: 4px solid blue;">@lang('back.floor_details')</h2>
                            <div class="row justify-content-between mb-4 mt-0 text-left">
                                ...
                                <div class="container mt-0">
                                    <div class="d-flex justify-start align-items-center">
                                        ...
                                        <button type="button" id="addFloorButtonRent"
                                            class="btn btn-primary btn-sm ">Add Floor <b>+</b></button>
                                    </div>
                                    <a id="propertyForm">

                                        <div id="floorContainerRent">
                                            @foreach ($property->floors as $index => $floor)

                                            <input type="hidden" name={{$floor->id}} id="deleted_images" value="">

                                           
                                                <div class="row justify-content-between mb-4 mt-3 text-left floor-group" id="floor-container-{{ $floor->id }}">
                                                    <div class="form-group col-sm-2 flex-column d-flex">
                                                        <label class="form-control-label px-3"><b>@lang('back.floor_no')</b>
                                                            <span style="font-size:11px !important;" class="mx-2 text-danger">0 for ground floor</span>
                                                        </label>
                                                        <input type="number" id="floorNo{{$index}}"
                                                            name="floors[{{$index}}][floorNo]"
                                                            value={{ $floor->floorNo }} 
                                                            class="form-control">
                                                    </div>
                                                    <div class="form-group col-sm-2 flex-column d-flex">
                                                        <label class="form-control-label px-3"><b>@lang('back.suite_no')</b>
                                                            <span style="font-size:11px !important;" class="mx-2 text-danger">0 for ground floor</span>
                                                        </label>
                                                        <input type="number" id="suitNo{{$index}}"
                                                            name="floors[{{$index}}][suitNo]"
                                                            value={{ $floor->suitNo }} 
                                                            class="form-control">
                                                    </div>
                                                    <div class="form-group col-sm-2 flex-column d-flex">
                                                        <label class="form-control-label px-3"><b>@lang('back.area_sqft')</b><span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" id="areaSqft{{$index}}"
                                                            name="floors[{{$index}}][areaSqft]"
                                                            value={{ $floor->areaSqft }} 
                                                            class="form-control">
                                                    </div>
                                                    <div class="form-group col-sm-2 flex-column d-flex">
                                                        <label class="form-control-label px-3"><b>@lang('back.rate_sqft')</b><span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" id="rateSqft{{$index}}"
                                                            name="floors[{{$index}}][rateSqft]"
                                                            value={{ $floor->rateSqft }} 
                                                            class="form-control">
                                                    </div>
                                                    <div
                                                        class="form-group col-sm-4 flex-column my-4 align-items-center d-flex">
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <div class="form-group d-flex">
                                                                <!-- Radio button for Rent -->
                                                                <div class="form-check mx-4 form-check-inline">
                                                                    <input
                                                                        class="form-check-input border align-items-center rounded-circle"
                                                                        style="padding: 10px !important;" type="radio"
                                                                        id="rent{{ $index}}"
                                                                        name="floors[{{ $index }}][type]"
                                                                        value="rent"
                                                                        {{ isset($floor) && $floor->type === 'rent' ? 'checked' : '' }}>
                                                                    <label class="form-check-label mx-1"
                                                                        for="rent${Index}"><b>@lang('back.rent')</b></label>
                                                                </div>
                                                                ...
                                                                <div class="form-check form-check-inline mx-2">
                                                                    <input
                                                                        ...
                                                                        name="floors[{{ $index}}][type]"
                                                                        value="sell"
                                                                        {{ isset($floor) && $floor->type === 'sell' ? 'checked' : '' }}>
                                                                    <label class="form-check-label mx-1"
                                                                        for="sell${Index}"><b>@lang('back.sell')</b></label>
                                                                </div>

                                                                <!-- Cancel button -->
                                                                <div class="d-flex " >
                                                                    <button type="button" onclick="event.preventDefault(); removeFloor({{$floor->id}});"  class="btn btn-danger btn-sm border rounded-pill align-items-center text-center mx-5 mb-3 cancel-floor-new" data-index="${floorIndex}" style="padding:2px !important; padding-right:12px !important; padding-bottom:6px !important; padding-left:12px !important;  border:1px solid red;  border-radius:100px !important; " >x</button>
                                                                   </div>
                                ...
                                <div class="row justify-content-start mt-3 text-left">
                                    <h2 class="d-flex justify-start px-2 my-5" style="border-left: 4px solid blue;">
                                        @lang('back.other_information')</h2>
                                    <div class="form-group col-sm-4  flex-column d-flex">
                                        <label class="form-control-label px-3"><b>@lang('back.parking_cap')</b><span
                                                class="text-danger">*</span></label>
                                        <input type="number" id="parkingcap" value={{ $property->parkingcap }}
                                            name="parkingcap" >
                                        @error('parkingcap')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group col-sm-4 flex-column d-flex">
                                        <label class="form-control-label px-3"><b>@lang('back.demand_sqft')</b><span
                                                class="text-danger">*</span></label>
                                        <input type="number" id="demandSqft" 
                                            name="demandSqft"  value={{ $property->demandSqft }}>
                                        @error('demandSqft')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-sm-4 flex-column d-flex">
                                        ...
                                        <input type="number" id="absValue" value={{ $property->absValue }}
                                            name="absValue" >
                                        @error('absValue')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <h2 class="d-flex justify-start px-2 my-5" style="border-left: 4px solid blue;">@lang('back.agent_details')</h2>
                            ...
                            <div class="row justify-content-between mt-5 mb-4 text-left">
                                ...
                                <div class="form-group col-sm-3 flex-column d-flex">
                                    ...
                                    <label class="form-control-label px-3"><b>@lang('back.agent_name')</b><span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="agentname" name="agentname"   value={{$property->agentname}}>
                                    @error('agentname')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-sm-3 flex-column d-flex">
                                    <label class="form-control-label px-3"><b>@lang('back.agent_contact')</b><span
                                            class="text-danger">*</span></label>
                                    <input type="number" id="agentcontact" value={{ $property->agentcontact }} 
                                        name="agentcontact" onblur="validateContact()" >
                                    @error('agentcontact')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row justify-content-between mt-3 text-left">
                                ...
                                <div class="form-group  col-md-12 flex-column my-4 d-flex">
                                    ...
                                    <form action="{{ route('admin.dashboard.updateProperty', $property->id ) }}" method="POST"
                                        ...
                                        <input type="file" name="images[]" class="py-5 col-sm-12"
                                            accept="image/jpeg, image/png, image/svg+xml" multiple>

                                            {{-- @if ($property->file_path)
                                            <img style="width: 60px !important; height: 60px !important" class="border border-white rounded-3" src={{asset('storage/'.$property->file_path)}} alt="">
                                        @endif --}}
                            ...
                            {{-- delete images array sending --}}
                            <input type="hidden" name="deleted_images" id="deleted_images" value="">

                            <input type="hidden" name="deleted_floor" id="deleted_floor" value="">

                            {{-- <input type="hidden" name="floors[{{ $index }}][id]" value="{{ $floor->id }}"> --}}

                            <div class="d-flex justify-start mt-4">
                                @foreach ($property_images as $images)
                                <div class="col-md-2" id="image-container-{{ $images->id }}">
                                    <div class="item">
                                        <a href="#" onclick="event.preventDefault(); removeImage({{ $images->id }});">
                                            <span class="notify-badge px-3 text-decoration-none">X</span>
                                        </a>
                                        <img src="{{ asset('storage/'.$images->file_path) }}" width="200" height="120" 
                                             style="border: 1px solid white; object-fit:cover; border-radius:20px;" alt="" />
                                    </div>
                                </div>
                                @endforeach
                            </div>
                            ...
                            <div class="row justify-content-center mt-5 text-left">
                                <div class="form-group col-sm-4 flex-column d-flex">
                                    <button type="submit" onclick="SubmitCheck(event)" class="btn btn-warning">@lang('back.update')</button>
                                </div>
                    </form>
                ...
                {{-- <form id="delete-image-{{ $property_images->id }}" action="{{ route('admin.edit.image.delete', $images->id) }}" method="POST" style="display:none;">
                    @csrf
                    @method('DELETE')
                </form> --}}
            </div>
...
function validateContact(){
        ...
        // Array to store IDs of deleted images
        let deletedImages = [];
    
        // Function to handle image removal
        function removeImage(imageId) {
            // Add the image ID to the deletedImages array
            if (!deletedImages.includes(imageId)) {
                deletedImages.push(imageId);
            }
    
            // Update the hidden input field with the array of deleted image IDs
            document.getElementById('deleted_images').value = deletedImages.join(',');
    
            // Optionally: Remove the image visually from the page
...
<script>
    ...
    function removeFloor(floorId) {
        // Add the image ID to the deletedImages array
        if (!deletedFloor.includes(floorId)) {
            deletedFloor.push(floorId);
        }

        // Update the hidden input field with the array of deleted image IDs
        document.getElementById('deleted_floor').value = deletedFloor.join(',');

        

        // Optionally: Remove the image visually from the page
        document.getElementById('floor-container-' + floorId).style.display = 'none';
    }
</script>
    ...
    <script>
        ...
        // let floorIndex = {{count($property->floors)}};
        //     let floorIndex = 0;
        //     let floorSuitCombination = {};

        $(document).ready(function() {
        let floorIndex = {{count($property->floors)+1}};
        let floorSuitCombination = {};
            ...
            <div class="row justify-content-between mb-4 mt-3 text-left floor-group" id="floor${floorIndex}">
                ...
                <div class="form-group col-sm-2 flex-column d-flex">
                    <label class="form-control-label px-3"><b>@lang('back.area_sqft')</b><span class="text-danger">*</span></label>
                    <input type="number" id="areaSqft${floorIndex}" name="floors[${floorIndex}][areaSqft]" class="form-control">
                </div>
                <div class="form-group col-sm-2 flex-column d-flex">
                    <label class="form-control-label px-3"><b>@lang('back.rate_sqft')</b><span class="text-danger">*</span></label>
        ...
        `);
            ...
            $('#floorContainerRent').on('click', '.cancel-floor-new', function() {
                const floorIndex = $(this).data('index');
                 $(`#floor${floorIndex}`).remove();
            });

            $('#floorContainerRent').on('click', '.cancel-floor-exist', function() {
                const floorIndex = $(this).data('index');
                 $(`#floor${floorIndex}`).remove();
            });
