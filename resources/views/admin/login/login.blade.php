                ...
                @endif
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3" >
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="{{route('forget.password.get')}}">@lang('auth.forgot_password')</a>
                        </div>
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">@lang('auth.sign_in')</button>
                        <p class="text-center mb-0">@lang('auth.dont_have_account')? <a href="/sign-up">@lang('auth.sign_up')</a></p>
                    </div>
