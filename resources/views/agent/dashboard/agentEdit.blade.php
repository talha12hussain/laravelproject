        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-12 col-lg-12 col-md-12 col-11 text-center">
                <div class="card">
                    ...
                    @endif
                    <form class="form-card" method="POST" action="{{ route('agent.dashboard.updateProperty', $property->id) }}"
                        ...
                        <div class="row justify-content-between mt-3 text-left">
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                ...
                                <select class="p-2 border rounded-3" id="plotType"  name="plot_type">
                                    <option {{$property->plot_type == "commercial" ? "selected" : ""}} value="commercial">@lang('messages.commercial')</option>
                                    <option {{$property->plot_type == "warehouse" ? "selected" : ""}} value="warehouse">@lang('messages.warehouse')</option>
                                    <option {{$property->plot_type == "shop" ? "selected" : ""}} value="shop">@lang('messages.shop')</option>
                                    <option {{$property->plot_type == "showroom" ? "selected" : ""}} value="showroom">@lang('messages.showroom')</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                ...
                                <select class="p-2 border rounded-3"  id="sizeType" name="size_type">
                                    <option  {{$property->size_type == "sq_yard" ? "selected" : ""}} value="sq_yard">@lang('back.square_yard')</option>
                                    <option {{$property->size_type == "acre" ? "selected" : ""}}  value="acre">@lang('back.acre')</option>
                                </select>
                            </div>
                        ...
                        <div class="my-2">
                                ...
                                <div class="container mt-0">
                                    <div class="d-flex justify-start align-items-center">
                                        ...
                                        <button type="button" id="addFloorButtonRent"
                                            class="btn btn-primary btn-sm ">@lang('back.add_floor') <b>+</b></button>
                                    </div>
                                    <a id="propertyForm">
                            ...
                            <div class="row justify-content-between mt-3 text-left">
                                ...
                                <div class="form-group  col-md-12 flex-column my-4 d-flex">
                                    ...
                                    <form action="{{ route('agent.dashboard.updateProperty', $property->id ) }}" method="POST"
                            ...
                            <div class="row justify-content-center mt-5 text-left">
                                <div class="form-group col-sm-4 flex-column d-flex">
                                    <button type="submit" onclick="SubmitCheck()" class="btn btn-warning">@lang('back.update')</button>
                                </div>
                    </form>
                </div>
                </form>
