            ...
            <div class="row h-150 align-items-center justify-content-center" style="min-height: 100vh;">
                ...
                @endif
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3" >
                        ...
                        <button type="submit" class="btn btn-warning py-3 w-100 mb-4">Send Password Reset Link</button>

                        
                        <p class="text-center mb-0">Don't have an Account? <a href="/sign-up">Sign Up</a></p>
                    </div>
